      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-gray-500 mb-1">Make</label>
            <input
              type="text"
              name="make"
              value={filters.make}
              ...
              className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-150"
            />
          </div>
        ...
        <div className="flex justify-end space-x-3 pt-2">
          <button
            type="button"
            onClick={handleReset}
            className="px-4 py-2 border border-gray-300 text-gray-700 font-medium rounded-lg text-sm bg-white hover:bg-gray-50 hover:shadow-sm active:scale-[0.98] transition duration-150 flex items-center gap-1.5"
          >
            <svg className="w-4 h-4 text-gray-550" fill="none" stroke="currentColor" viewBox="0 0 24 24">
